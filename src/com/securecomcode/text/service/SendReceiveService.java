...
import com.securecomcode.text.crypto.InvalidPassphraseException;
import com.securecomcode.text.crypto.MasterSecretUtil;
import com.securecomcode.text.database.CanonicalSessionMigrator;
import com.securecomcode.text.util.TextSecurePreferences;
import com.securecomcode.text.util.WorkerThread;
...
public class SendReceiveService extends Service {
  ...
  public static final String SEND_SMS_ACTION                  = "com.securecomcode.text.SendReceiveService.SEND_SMS_ACTION";
  public static final String SENT_SMS_ACTION                  = "com.securecomcode.text.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION             = "com.securecomcode.text.SendReceiveService.DELIVERED_SMS_ACTION";
  public static final String RECEIVE_SMS_ACTION               = "com.securecomcode.text.SendReceiveService.RECEIVE_SMS_ACTION";
  public static final String SEND_MMS_ACTION                  = "com.securecomcode.text.SendReceiveService.SEND_MMS_ACTION";
  public static final String RECEIVE_MMS_ACTION               = "com.securecomcode.text.SendReceiveService.RECEIVE_MMS_ACTION";
  public static final String DOWNLOAD_MMS_ACTION              = "com.securecomcode.text.SendReceiveService.DOWNLOAD_MMS_ACTION";
  public static final String DOWNLOAD_MMS_CONNECTIVITY_ACTION = "com.securecomcode.text.SendReceiveService.DOWNLOAD_MMS_CONNECTIVITY_ACTION";
  public static final String DOWNLOAD_MMS_PENDING_APN_ACTION  = "com.securecomcode.text.SendReceiveService.DOWNLOAD_MMS_PENDING_APN_ACTION";
  public static final String RECEIVE_PUSH_ACTION              = "com.securecomcode.text.SendReceiveService.RECEIVE_PUSH_ACTION";
  public static final String DECRYPTED_PUSH_ACTION            = "com.securecomcode.text.SendReceiveService.DECRYPTED_PUSH_ACTION";
  public static final String DOWNLOAD_PUSH_ACTION             = "com.securecomcode.text.SendReceiveService.DOWNLOAD_PUSH_ACTION";
  public static final String DOWNLOAD_AVATAR_ACTION           = "com.securecomcode.text.SendReceiveService.DOWNLOAD_AVATAR_ACTION";
