 ...
 */
package com.securecomcode.text.database;
...
import com.securecomcode.text.database.model.DisplayRecord;
import com.securecomcode.text.database.model.MediaMmsMessageRecord;
import com.securecomcode.text.database.model.MessageRecord;
import com.securecomcode.text.database.model.NotificationMmsMessageRecord;
import com.securecomcode.text.mms.IncomingMediaMessage;
import com.securecomcode.text.mms.PartParser;
import com.securecomcode.text.mms.SlideDeck;
import com.securecomcode.text.mms.TextSlide;
...
import com.securecomcode.text.util.LRUCache;
import org.whispersystems.textsecure.util.ListenableFutureTask;
import com.securecomcode.text.util.Trimmer;
...
public class MmsDatabase extends Database implements MmsSmsColumns {
  ...
  public static final ExecutorService slideResolver = com.securecomcode.text.util.Util.newSingleThreadedLifoExecutor();
      ...
      throws MmsException
  {
    ...
    boolean       unread        = com.securecomcode.text.util.Util.isDefaultSmsProvider(context) ||
  ...
  public Pair<Long, Long> insertMessageInbox(NotificationInd notification) {
    try {
      ...
      contentValues.put(STATUS, Status.DOWNLOAD_INITIALIZED);
      contentValues.put(DATE_RECEIVED, System.currentTimeMillis() / 1000);
      contentValues.put(READ, com.securecomcode.text.util.Util.isDefaultSmsProvider(context) ? 0 : 1);
...
//      Trimmer.trimThread(context, threadId);
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.securecomcode.text.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!Util.isEmpty(contentLocation))
        contentLocationBytes = com.securecomcode.text.util.Util.toIsoBytes(contentLocation);

      if (!Util.isEmpty(transactionId))
        transactionIdBytes = com.securecomcode.text.util.Util.toIsoBytes(transactionId);
